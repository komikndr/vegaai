...
# Register providers
#llm_factory.register_provider( "ollama", OllamaProvider(os.getenv("OLLAMA_URL")))
...
# llm_factory.register_provider("openai", ODIProvider())

#print(llm_factory.list_models(capabilities=capabilities))
